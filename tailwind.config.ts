  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'fade-out-slide-up': {
          '0%': { opacity: '1', transform: 'translateY(0)', height: '100%' },
          '100%': { opacity: '0', transform: 'translateY(-20px)', height: '0%' },
        },
      },
      animation: {
        ...
        'fade-out-slide-up': 'fade-out-slide-up 0.3s ease-out forwards',
      },
    },
  },
