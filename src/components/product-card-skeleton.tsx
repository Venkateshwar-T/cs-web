...
export function ProductCardSkeleton() {
  return (
    <div className="bg-white/80 text-black rounded-lg md:rounded-2xl overflow-hidden flex flex-col h-full shadow-custom-dark animate-pulse">
      <div className="relative w-full pt-[80%] bg-gray-300/50 rounded-t-lg md:rounded-t-2xl"></div>
