            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <DetailRow icon={<Phone size={16} />} label="Phone" value={
                    <div className="flex items-center gap-2">
                        ...
                        {isMobile && order.customerPhone && (
                            <a href={`tel:${order.customerPhone}`} className="text-white/80 hover:text-white">
                                <Phone size={16} />
                            </a>
                        )}
                    </div>
                ...
                <Separator className="bg-white/20 sm:col-span-2" />
            ...
            <Separator className="bg-white/20" />
             ...
             <div className="flex flex-col items-center justify-center gap-2 mt-2">
                ...
                <div onClick={(e) => e.stopPropagation()}>
                        <Select onValueChange={(value) => handleStatusChange(value as Order['status'])} defaultValue={order.status}>
                          <SelectTrigger className={cn(
                            "w-full md:w-[160px] h-9 text-xs rounded-full border-none focus:ring-0 focus:ring-offset-0",
