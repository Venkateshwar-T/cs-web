      ...
      <div className="container max-w-screen-2xl px-8 md:px-12 mt-16">
        <div className="relative max-w-2xl mx-auto">
          ...
          <Input 
            ...
            className="w-full pl-10 pr-4 py-2 rounded-full bg-gradient-to-br from-white to-custom-purple-dark border-none focus-visible:ring-0 focus-visible:ring-offset-0"
          />
        </div>
      </div>
    </header>
