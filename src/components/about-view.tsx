...
export function AboutView() {
  return (
    <div className="bg-[#5D2B79] rounded-t-[40px] mx-8 md:mx-32 animate-fade-in" style={{ animationDuration: '0.5s', animationDelay: '0.2s', animationFillMode: 'both' }}>
        <div className="bg-white/20 rounded-t-[40px] py-10 px-12 md:px-24">
