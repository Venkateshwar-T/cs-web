...
function FacebookIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            fill="white"
        >
            <path d="M22 0H2a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z" />
            <path fill="hsl(var(--primary))" d="M15.402 24v-9.255h3.102l.464-3.6h-3.566V8.82c0-1.042.29-1.752 1.783-1.752h1.905V3.725a26.115 26.115 0 0 0-2.775-.145c-2.747 0-4.627 1.676-4.627 4.757v2.618H8.583v3.6h3.102V24h3.717z" />
        </svg>
    )
}
