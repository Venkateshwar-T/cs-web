...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen">
      <Header isSearchActive={isSearchActive} onSearchSubmit={() => setIsSearchActive(true)} />
      <main className={`flex-grow pt-72 overflow-hidden transition-opacity duration-500 ${isSearchActive ? 'opacity-0' : 'opacity-100'}`}>
